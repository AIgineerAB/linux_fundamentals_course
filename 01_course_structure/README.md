...
| shell scripts    | .sh files for bash code                            | lecture directory            |

there is also a lab, which is only available for the students that are enrolled in this course. The lab is found in their learning management system (LMS).
